        ...
        <div className="container mx-auto px-5 md:px-12 grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-[18px] leading-relaxed mb-12">
              Let us bring beauty, harmony, and tranquility to your outdoor oasis
              with our expert landscaping services. Your journey to a more
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Reach us from 9 am – 6 pm</p>
                </div>
              </div>
      ...
      <section className="w-full py-32 md:py-40 bg-[#F5F7F8]">
        <div className="container mx-auto px-5 md:px-16 text-center">
          ...
          >
            ...
            difference that passion, creativity, and expertise can make in
            your outdoor space.
          </motion.p>
          ...
          >
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <button
                type="submit"
                className="bg-blue-900 text-white py-3 rounded-md w-full md:col-span-2 text-xl hover:bg-blue-800 transition"
              >
                Send message
              </button>
