...
import service4 from "../assets/gallery6.avif";
    ...
    <div className="w-full">
          ...
          <div className="max-w-9xl mx-auto flex flex-col md:flex-row items-center gap-10 px-5 md:px-16">
            ...
            >
              ...
              <p className="text-base md:text-lg mb-6 text-center md:text-left">
                Care Corner, Founded by Dr. Nida Maqbool, Care Corner offers
                compassionate, evidence-based mental health support in a safe
                and calming space. From anxiety and depression to relationship
                challenges, we provide personalized therapy that helps you heal,
                grow, and rediscover emotional balance. Your journey to a
                healthier, happier life starts here.
              </p>
              ...
              <div className="flex flex-col gap-4 mt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600 text-sm">
                      Experienced in providing evidence-based mental health care
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <br />
                    <span className="text-gray-600 text-sm">
                      Focused on emotional healing, stress reduction & overall
                      well-being
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <br />
                    <span className="text-gray-600 text-sm">
                      Skilled in CBT, mindfulness practices & relationship
                      counseling
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <br />
                    <span className="text-gray-600 text-sm">
                      Safe, empathetic & client-centered approach for long-term
                      resilience
                    </span>
                  </div>
                </div>
      ...
      <div className="w-full flex flex-col md:flex-row px-5 md:px-16 py-12 md:py-20">
        ...
        <div className="w-full md:w-1/3 md:sticky md:top-24 h-fit mb-10 md:mb-0">
          <h3 onClick={() => navigate("/services")} className="inline-block cursor-pointer text-[#057C8B] font-semibold border-2 border-[#057C8B] rounded-full px-3 py-1 mb-3">
            Services
          </h3>
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                >
                  ...
                  <span className="ml-2 bg-black text-white rounded-full p-1 flex items-center justify-center">
                    <FaArrowLeft
                      className="rotate-180 w-3 h-3 md:w-4 md:h-4"
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <p className="text-gray-700 text-base md:text-lg">
                Start your journey towards a brighter tomorrow with expert
                therapy. Our specialized sessions are designed to address your
                unique needs, offering the support and guidance you need to
                overcome challenges and embrace a healthier, more fulfilling
                future.
              </p>
              <p
                className="text-[#057C8B] font-semibold underline mt-2 w-max cursor-pointer"
      ...
      <section className="w-full py-12 md:py-20 px-5 md:px-16 bg-white overflow-hidden">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Step into a calm and comforting space where healing begins the
            moment you arrive.
          </p>
        </div>
      ...
      <section className="w-full bg-[#e6eff2] py-12 md:py-20 px-5 md:px-16 overflow-hidden">
        ...
        <div className="text-center">
          ...
          <Link to='https://www.instagram.com/care_corner_ranchi/' target="_blank">View All Posts</Link>
          </button>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-12 md:py-20 px-5 md:px-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Supportive and structured sessions that help you understand
            emotional patterns, rebuild motivation, and find renewed balance and
            purpose.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-6">
          ...
          <div className="relative w-full md:w-1/3 rounded-lg overflow-hidden border border-gray-300 shadow-md">
            ...
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/oGOsAq1e7xQ?si=T1Rf8o5DhfoM9rzR"
          ...
          <div className="relative w-full md:w-1/3 rounded-lg overflow-hidden border border-gray-300 shadow-md">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/jh48of5Mw1k?si=r8Ed9QBtflFKKrBF"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin"
          ...
          <div className="relative w-full md:w-1/3 rounded-lg overflow-hidden border border-gray-300 shadow-md">
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/B5LS_t8YVUk?si=-5wV8uVTwxAxb7W-"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              referrerpolicy="strict-origin-when-cross-origin"
        ...
        <div className="text-center">
          <button className="inline-block border-2 border-black rounded-full px-6 py-3 font-semibold text-black hover:bg-black hover:text-white transition-colors duration-300">
          <Link to='https://www.youtube.com/@carecorner6332' target="_blank">View All Videos</Link>
          </button>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          ...
          <div className="relative w-full md:w-1/3 rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              <h3 className="text-xl font-semibold mb-2">
                5 Ways to Improve Emotional Well-being
              </h3>
              <p className="text-gray-600 text-sm">
                Learn strategies to manage stress and boost happiness in daily
                life.
              </p>
            </div>
          </div>
          ...
          <div className="relative w-full md:w-1/3 rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              ...
              <p className="text-gray-600 text-sm">
                Tips and techniques to stay strong and focused during adversity.
              </p>
            </div>
          </div>
          ...
          <div className="relative w-full md:w-1/3 rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              ...
              <p className="text-gray-600 text-sm">
                Practical advice to reduce stress and maintain mental clarity.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-16 px-16 sm:px-16 md:px-16 rounded-2xl">
        <div className="max-w-7xl mx-auto flex flex-col p-5 bg-[#057C8B] rounded-2xl items-center text-center gap-6">
          ...
          <p className="text-gray-200 text-base sm:text-lg md:text-xl max-w-3xl">
            Book your appointment today and experience expert care designed
            around you to be better. Our service is tailored to your needs,
            helping you regain balance and improve well-being.
          </p>
