...
import Apoint from "../assets/appoinment.jpg";
      ...
      <section className="w-full bg-white px-6 md:px-24 pb-32 md:pb-40">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            >
              We are here to support you with compassion, expertise, and genuine
              care.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          ...
          >
            <h2
              ...
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              A guidance & counselling <br />
              center with a leading counselling psychologist
            </h2>

            <p className="text-gray-600 mt-6 leading-relaxed text-lg max-w-md">
              Our step-by-step therapeutic approach simplifies emotional
              challenges, provides personalized strategies, and guides you
              toward measurable mental wellness.
            </p>

            <div className="flex items-center gap-2 mt-8">
              <img src="/star.svg" className="w-5" alt="" />
              <span className="text-gray-700 font-medium">
                4.5 Rated by loving Clients
              </span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-semibold text-gray-900 leading-tight">
              Our journey began with a<br />
              simple mission
            </h2>

            <p className="mt-6 text-gray-600 leading-relaxed text-lg max-w-xl">
              We started with one goal — to offer a safe, supportive space for
              people to heal.
            </p>

            <p className="mt-4 text-gray-600 leading-relaxed text-lg max-w-xl">
              Today, we help individuals overcome stress, anxiety, relationship
              issues, and emotional struggles with clarity.
            </p>
